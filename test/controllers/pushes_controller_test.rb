...
class PushesControllerTest < ActionController::TestCase
  ...
  test "should create push" do
    assert_difference('Push.count') do
      post :create, push: { date: @push.date, description: @push.description, name: @push.name, owner: @push.owner, url: @push.url }
    end
  ...
  test "should update push" do
    patch :update, id: @push, push: { date: @push.date, description: @push.description, name: @push.name, owner: @push.owner, url: @push.url }
    assert_redirected_to push_path(assigns(:push))
  end
